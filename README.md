...
This project focuses on Customer Segmentation using Data Analytics and Machine Learning.
The goal is to analyze customer behavior and segment customers into meaningful groups to support data-driven business decisions.

The project not only fulfills the basic task requirements but also includes advanced analytical techniques and business intelligence insights.
